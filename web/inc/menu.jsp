      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="web03busquedadocumentosxml.jsp">Búsqueda en documentos XML</a></li>
        ...
        <li class="nav-item"><a class="nav-link" href="web03busquedadocumentosxml.jsp">Buscar XML</a></li>
        <li class="nav-item"><a class="nav-link" href="web04cochesbasicosxml.jsp">Coches1</a></li>
